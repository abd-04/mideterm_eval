            ...
            <div class="col-lg-8">
                <div class="card shadow-lg border-0">
                    <div class="card-header bg-primary text-white p-4">
                        <h2 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Property</h2>
                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="index.php?page=edit_property&id=<?php echo $property['id']; ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="area_id" name="area_id" required>
                                        ...
                                        <?php foreach ($areas as $area): ?>
                                            <option value="<?php echo $area['id']; ?>" <?php echo (isset($formData['area_id']) && $formData['area_id'] == $area['id']) ? 'selected' : ''; ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <img src="uploads/<?php echo htmlspecialchars($property['main_image']); ?>" 
                                             alt="Current property image" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                </div>
                            <?php endif; ?>
                            
                            <div class="mb-4">
                                <label for="main_image" class="form-label fw-bold">Main Image <?php echo !empty($property['main_image']) ? '(Optional - Leave blank to keep current image)' : ''; ?></label>
                                <input type="file" class="form-control" id="main_image" name="main_image" accept="image/*">
                                <div class="form-text">Upload a new image to replace the current one (JPG, PNG). Max size 5MB.</div>
